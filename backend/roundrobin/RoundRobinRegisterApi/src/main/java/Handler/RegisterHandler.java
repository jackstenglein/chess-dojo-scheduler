...
public class RegisterHandler {
     ...
     * @param lichesscollection  the lichesscollection
     * @param chessComCollection the chess com collection
     * @param discordID          the discord id
     * @param discordName        the discord name
     * @param startCohort        the start cohort
     * @param lichessName        the lichess name
     * @param chessComName       the chess com name
