...
/**
 * This class handles the registration of players for the round-robin
 * tournament.
 */
public class RegisterHandler {
     ...
     */
    public String playerRegister(String discordID, String discordName, int startCohort, String lichessName,
            String chessComName, String dojoUsername) throws IOException, RoundRobinException {
        ...
        if ((lichessName.equalsIgnoreCase("null") || lichessName.equalsIgnoreCase(""))
                && (chessComName.equalsIgnoreCase("null") || chessComName.equalsIgnoreCase(""))) {
            throw new IOException("Lichess or Chess.com account name must be provided");
        }

        String nonDiscordUserName = discordName.equalsIgnoreCase("null") || discordName.equalsIgnoreCase("")
                ? dojoUsername
                : discordName;
        String nonDiscordUserID = discordID.equalsIgnoreCase("null") || discordID.equalsIgnoreCase("") ? dojoUsername
                : discordID;
