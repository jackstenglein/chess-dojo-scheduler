...
func main() {
	...
	if err = media.Download("chess-dojo-email-templates", "dojoDigest24Minified.html", f); err != nil {
	...
	for {
		...
		msg.SetHeader("Subject", "New UI, Performance Stats & Annotation Workshop | Digest Vol. 24")
