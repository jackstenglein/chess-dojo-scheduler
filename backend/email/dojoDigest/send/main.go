...
func main() {
	...
	if err = media.Download("chess-dojo-email-templates", "liveClassesPresaleMinified.html", f); err != nil {
	...
	for {
		...
		msg.SetHeader("Subject", "ChessDojo Live Classes on Sale Now | 25% Off Until Dec 2nd")
