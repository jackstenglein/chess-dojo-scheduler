...
func main() {
	...
	if err = media.Download("chess-dojo-email-templates", "dojoDigest17Minified.html", f); err != nil {
	...
	for {
		...
		msg.SetHeader("Subject", "Round Robin Tournaments, Custom Tasks, & more! | Digest Vol. 17")
