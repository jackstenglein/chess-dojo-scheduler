...
func main() {
	...
	if err = media.Download("chess-dojo-email-templates", "dojoDigest15Minified.html", f); err != nil {
	...
	for {
		...
		msg.SetHeader("Subject", "World Championship Discount | Dojo Digest Vol. 15")
