...
func main() {
	...
	if err = media.Download("chess-dojo-email-templates", "dojoDigest21Minified.html", f); err != nil {
	...
	for {
		...
		msg.SetHeader("Subject", "40% Off ChessDojo, New Features, & More! | Digest Vol. 21")
