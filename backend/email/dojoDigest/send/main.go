...
func main() {
	...
	if err = media.Download("chess-dojo-email-templates", "dojoDigest23Minified.html", f); err != nil {
	...
	for {
		...
		msg.SetHeader("Subject", "My Games Folder, Annotation Workshop, & Other News | Digest Vol. 23")
