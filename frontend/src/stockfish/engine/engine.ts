...
/** Settings for adding info only on last move when using spacebar analysis. */
export const ENGINE_KEEP_INFO_ONLY_ON_LAST_MOVE = {
    /** Local storage key for the spacebar behavior. */
    Key: 'engine-keep-info-only-on-last-move',
    /** The default value. */
    Default: true,
};
