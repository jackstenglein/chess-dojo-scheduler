            ...
            <Stack spacing={4}>
                ...
                <Stack spacing={3}>
                    <InfoEntryAccordion icon='info' title='Tournament Overview'>
                        <Typography>
                            This is a 7-round tournament run over 7 weeks, with one round
                            per week. Because this is a short tournament, we ask that you
                            only register if you anticipate that you will be able to play
                            most of the rounds. If you do require a bye in a particular
                            round, you will be able to submit your bye requests when
                            registering. Please submit all of your bye requests when you
                            register. Players are limited to 2 bye requests per
                            tournament. A new 7-round tournament will start again
                            approximately one week after the last one ends.
                        </Typography>
                    </InfoEntryAccordion>

                    <InfoEntryAccordion icon='player' title='Tournament Director'>
                        <Typography>
                            Alex Dodd (alexdodd on Discord) is the tournament director.
                    ...
                    <InfoEntryAccordion icon='eventCheck' title='Registering'>
                        <Typography>
                            ...
                            submitted successfully. We cannot accept late registrations.
                            If you miss the registration window, you will have to wait
                            until the next tournament starts to sign up.
                        </Typography>
                    </InfoEntryAccordion>
                    ...
                    <InfoEntryAccordion icon='cohort' title='Pairings'>
                        <Typography>
                            ...
                            will include your and your partner's Lichess and Discord
                            usernames so that you can contact each other to schedule your
                            game. It is up to you and your pairing partner to schedule a
                            time to play your game each week.
                        </Typography>
                    </InfoEntryAccordion>
                    ...
                    >
                        ...
                        <Typography>
                            ...
                            preferred one only if both players agree. If a time control is
                            not agreed upon, the preferred time control will be used. If
                            one player cannot agree to play the preferred time control
                            they will forfeit the game.
                        </Typography>
                        <Typography mt={2}>
                            Similarly, rated games are preferred, but unrated games are
                            allowed if both players agree. If one player cannot agree to
                            play a rated game they will forfeit the game.
                        </Typography>
                    </InfoEntryAccordion>

                    <InfoEntryAccordion icon='submit' title='Submitting Results'>
                        <Typography>
                            Once you have completed your game, the winner takes
                            responsibility for submitting the game result. In the case of
                            a draw, you'll have to decide which one of you will submit the
                            game. Please do not submit the game twice. Navigate to the{' '}
                            ...
                            must be submitted no later than Sunday at midnight EST.{' '}
                            <strong>We cannot accept late game submissions.</strong> Not
                            submitting your games in time will result in a forfeit loss
                            for both players (0 - 0).
                        </Typography>
                    </InfoEntryAccordion>
                    ...
                    <InfoEntryAccordion icon='warning' title='Disputes'>
                        ...
                        <ol>
                            ...
                            <li>
                                does not make a concerted effort* to schedule a game in a
                                round
                            </li>
                            <li>
                                does not show up within 30 minutes of an agreed upon time
                                to play
                            </li>
                        </ol>
                        Then you can:
                        <ul>
                            ...
                            <li>
                                ...
                                report your opponent - this alerts the TD that your
                                opponent should be considered for removal from this and
                                future tournaments
                            </li>
                            <li>
