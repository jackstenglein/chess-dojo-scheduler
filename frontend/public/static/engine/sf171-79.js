var Sf17179Web = (() => {
    ...
    return async function (moduleArg = {}) {
        ...
        function findWasmBinary() {
            // Updated from base SF script
            return `${window.location.origin}/static/engine/sf171-79.wasm`;
        }
        ...
        var PThread = {
            ...
            allocateUnusedWorker() {
                // Updated from base SF
                var worker = new Worker(
                    new URL(`${window.location.origin}/static/engine/sf171-79.js`),
                    {
                        type: 'module',
                        name: 'em-pthread',
                    },
